<template lang="">
      ...
      <div class="flex justify-center wrap mx-auto">
        <div
          ...
          <div class="p-6">
            ...
            <a href="https://outlook.office365.com/owa/calendar/consultblueracccooncoza@blueraccoon.co.za/bookings/s/fW1JhTF9X0GtGqrAfPxOpA2">
              <button
                type="button"
        ...
        <div
          ...
          <div class="p-6">
            ...
            <p class="mb-4 text-base text-neutral-600">
              we will help you transition from your current, paper-based business environment to optimised digital document processes
            </p>
            <a href="https://outlook.office365.com/owa/calendar/consultblueracccooncoza@blueraccoon.co.za/bookings/s/fW1JhTF9X0GtGqrAfPxOpA2">
              <button
                type="button"
        ...
        <div
          ...
          <div class="p-6">
            ...
            <p class="mb-4 text-base text-neutral-600">
              From next generation Wireless, Fibre, Surveillance and Access Control, to world-class Voice and Telephony
            </p>
            <a href="https://outlook.office365.com/owa/calendar/consultblueracccooncoza@blueraccoon.co.za/bookings/s/fW1JhTF9X0GtGqrAfPxOpA2">
              <button
                type="button"
      ...
      <div class="flex justify-center wrap mx-auto">
        <div
          ...
          <div class="p-6">
            ...
            <p class="mb-4 text-base text-neutral-600">
              provides a comprehensive service program focused on rapid resolution to keep your automation operational and your staff supported
            </p>
            <a href="https://outlook.office365.com/owa/calendar/consultblueracccooncoza@blueraccoon.co.za/bookings/s/fW1JhTF9X0GtGqrAfPxOpA2">
              <button
                type="button"
        ...
        <div
          ...
          <div class="p-6">
            ...
            <p class="mb-4 text-base text-neutral-600">
              Over 2,000 companies have strengthened their talent pipeline with MoBerries. The modern way to recruit. Modern Recruiting solution made simple
            </p>
            <a href="https://outlook.office365.com/owa/calendar/consultblueracccooncoza@blueraccoon.co.za/bookings/s/fW1JhTF9X0GtGqrAfPxOpA2">
              <button
                type="button"
        ...
        <div
          ...
          <div class="p-6">
            ...
            <p class="mb-4 text-base text-neutral-600">
              ...
              RICOH enables individuals to work smarter, and by providing fulfillment through work.
            </p>
            <a href="https://outlook.office365.com/owa/calendar/consultblueracccooncoza@blueraccoon.co.za/bookings/s/fW1JhTF9X0GtGqrAfPxOpA2">
              <button
                type="button"
  ...
  .prt-1 {
    background-color: rgba(122, 117, 116, 0.726);

    ...
    <ol class="border-l-2 border-orange-500 bg-white p-2 rounded shadow-xl">
      ...
      <li>
        <div class="flex-start flex items-center">
          ...
          <h4 class="-mt-2 text-xl font-semibold">Design</h4>
        </div>
        <div class="ml-6 mb-6 pb-6">
          <p
            href="#!"
      ...
      <li>
        <div class="flex-start flex items-center">
          <div
            class="-ml-[9px] mr-3 -mt-2 flex h-4 w-4 items-center justify-center rounded-full bg-primary dark:bg-primary-500"></div>
          <h4 class="-mt-2 text-xl font-semibold">Development</h4>
        </div>
        <div class="ml-6 mb-6 pb-6">
          <p
            href="#!"
      ...
      <li>
        <div class="flex-start flex items-center">
          <div
            class="-ml-[9px] mr-3 -mt-2 flex h-4 w-4 items-center justify-center rounded-full bg-primary dark:bg-primary-500"></div>
          <h4 class="-mt-2 text-xl font-semibold">Implementation</h4>
        </div>
        <div class="ml-6 mb-6 pb-6">
          <p
            href="#!"
      ...
      <li>
        <div class="flex-start flex items-center">
          <div
            class="-ml-[9px] mr-3 -mt-2 flex h-4 w-4 items-center justify-center rounded-full bg-primary dark:bg-primary-500"></div>
          <h4 class="-mt-2 text-xl font-semibold">Maintanace</h4>
        </div>
        <div class="ml-6 mb-6 pb-6">
          <p
            href="#!"

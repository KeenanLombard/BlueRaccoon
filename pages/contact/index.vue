<template lang="">
  <div class="grid lg:grid-cols-3 md:grid-cols-1">
    <!-- Contact sub route
    <p>Book Consult - Free Service</p>
    <p>Book Technical - Texhnical Advice</p>
    <p>Bookm Pre-Sales - Partner Service</p>
    <p>Book Demo - Guided Service</p>
    <p>Self-Service Portal Login</p> -->
    <div
      v-for="item in data"
